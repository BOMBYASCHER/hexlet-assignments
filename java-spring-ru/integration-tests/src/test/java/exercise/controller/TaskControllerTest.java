...
class ApplicationTest {
    ...
    public void testCreate() throws Exception {
        ...
        var response = request
                ...
                .getResponse()
                .getContentAsString();
        assertThat(taskRepository.findById(om.readValue(response, Task.class).getId())).isPresent();
        assertThatJson(response).and(
                a -> a.node("title").isEqualTo(task.getTitle()),
                a -> a.node("description").isEqualTo(task.getDescription())
        );
    ...
    public void testUpdate() throws Exception {
        ...
        var request = mockMvc.perform(put("/tasks/" + task.getId())
                .contentType(MediaType.APPLICATION_JSON)
        ...
        assertThatJson(response).node("description").isEqualTo(description);
    }
