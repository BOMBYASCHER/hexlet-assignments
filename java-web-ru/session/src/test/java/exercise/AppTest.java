...
class AppTest {
    ...
    void testLoginPass() throws Exception {
        ...
        assertThat(body1, containsString("Log in"));
        assertThat(body1, is(not(containsString("Log out"))));
        ...
        assertThat(body3, containsString("Log out"));
        assertThat(body3, is(not(containsString("Log in"))));
        ...
        assertThat(body4, containsString("Log in"));
        assertThat(body4, is(not(containsString("Log out"))));
    }
